...
{% endif -%}
{% if has_api %}
from {{ cookiecutter.project_slug }}.adapters.api.app import app as api_app
{% endif -%}
{% if has_soap %}
from {{ cookiecutter.project_slug }}.adapters.soap.app import app as soap_app
{% endif -%}
{% if has_portal %}
from {{ cookiecutter.project_slug }}.adapters.portal.app import app as portal_app
{% endif -%}
{% if has_web %}
from {{ cookiecutter.project_slug }}.adapters.web.app import app as web_app
{% endif -%}
